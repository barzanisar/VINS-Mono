...
class IntegrationBase
{
  public:
...

    {
        ...
        noise_model(0,0) = PROPELLER_FORCE_N * PROPELLER_FORCE_N; // sigma_Fz_0 squared // multiply by 4 bcz 4 propellors?
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        Vector3d control_acc_0 = delta_q * body_thrust_0; // same as delta_q.toRotationMatrix() * body_thrust_0;

        result_delta_q = delta_q * Quaterniond(1, un_gyr(0) * _dt / 2, un_gyr(1) * _dt / 2, un_gyr(2) * _dt / 2);

        Vector3d un_acc_1 = result_delta_q * (_acc_1 - linearized_ba);
        Vector3d control_acc_1 = result_delta_q * body_thrust_1; //same as result_delta_q.toRotationMatrix() * body_thrust_1;
        ...
        if(update_jacobian)
        {
            ...
            MatrixXd V_model = MatrixXd::Zero(12,11); //fz0 noise,gyr0 noise, fz1 noise, gyr1 noise, bw noise
            ...
            step_jacobian = F; //only for printing
            step_V = V; //only for printing
            jacobian = F * jacobian;
